...
class LSTMMultiDilationChordCNNC(nn.Module):
    """
    LSTM Multi-Dilation Architecture C: Dilations [4, 8, 16] with mid attention
    """
    def __init__(self, num_classes, input_height=9, input_width=24,
                 lstm_hidden_size=64, lstm_num_layers=2,
                 branch_out_channels=12, dilations=[4, 8, 16],
                 kernel_size=3, fc_size=128, dropout_rate=0.25):
        super(LSTMMultiDilationChordCNNC, self).__init__()
        ...
        # First Multi-Dilation Block - Mid attention
        ...
        # Second Multi-Dilation Block - Mid attention
