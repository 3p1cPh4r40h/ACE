...
class MultiDilationMidSqueezeSoftmaxChordCNN(nn.Module):
    """
    ...
    def __init__(self, num_classes, input_height=9, input_width=24,
        ...
        super(MultiDilationMidSqueezeSoftmaxChordCNN, self).__init__()
    ...
    def forward(self, x):
        ...
        # 4. Mid Squeeze with Softmax
        # Apply softmax along the feature dimension
        x = F.softmax(x, dim=1)
