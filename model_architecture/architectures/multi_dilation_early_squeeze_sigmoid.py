...
class MultiDilationEarlySqueezeSigmoidChordCNN(nn.Module):
    """
    ...
    def __init__(self, num_classes, input_height=9, input_width=24,
        ...
        super(MultiDilationEarlySqueezeSigmoidChordCNN, self).__init__()
    ...
    def forward(self, x):
        ...
        # 3. Early Squeeze with Sigmoid
        # Apply sigmoid along the channel dimension
        x = torch.sigmoid(x)
