...
class SmallDilationLastModel(nn.Module):
    """
    A CNN model for chord extraction using dilated convolution only in the last layer.
    This model uses standard convolutions in the first two layers and a dilated convolution
    (rate=2) in the final layer.
    """
    def __init__(self, num_classes, input_height=9, input_width=24):
        super(SmallDilationLastModel, self).__init__()
        ...
        # Layer 3: Dilated convolution (rate=2)
        kernel_size3 = 3
        dilation3 = 2
