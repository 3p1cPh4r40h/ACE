...
class LSTMMultiDilationChordCNND(nn.Module):
    """
    LSTM Multi-Dilation Architecture D: Dilations [8, 16, 32] with late attention
    """
    def __init__(self, num_classes, input_height=9, input_width=24,
                 lstm_hidden_size=64, lstm_num_layers=2,
                 branch_out_channels=12, dilations=[8, 16, 32],
                 kernel_size=3, fc_size=128, dropout_rate=0.25):
        super(LSTMMultiDilationChordCNND, self).__init__()
        ...
        # First Multi-Dilation Block - Late attention
        ...
        # Second Multi-Dilation Block - Late attention
