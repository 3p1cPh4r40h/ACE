...
class LSTMMultiDilationChordCNNB(nn.Module):
    """
    LSTM Multi-Dilation Architecture B: Dilations [2, 4, 8] with early attention
    """
    def __init__(self, num_classes, input_height=9, input_width=24,
                 lstm_hidden_size=64, lstm_num_layers=2,
                 branch_out_channels=12, dilations=[2, 4, 8],
                 kernel_size=3, fc_size=128, dropout_rate=0.25):
        super(LSTMMultiDilationChordCNNB, self).__init__()
        ...
        # Second Multi-Dilation Block - Early attention
