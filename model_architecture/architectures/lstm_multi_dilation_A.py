...
class LSTMMultiDilationChordCNNA(nn.Module):
    """
    LSTM Multi-Dilation Architecture A: Basic version with dilations [1, 2, 4] and no attention
    """
    def __init__(self, num_classes, input_height=9, input_width=24,
        ...
        super(LSTMMultiDilationChordCNNA, self).__init__()
        ...
        # First Multi-Dilation Block - No attention
        ...
        # Second Multi-Dilation Block - No attention
