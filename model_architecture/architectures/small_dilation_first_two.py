...
class SmallDilationFirstTwoModel(nn.Module):
    """
    A CNN model for chord extraction using dilated convolutions only in the first two layers.
    The third layer uses standard convolution.
    """
    def __init__(self, num_classes, input_height=9, input_width=24):
        super(SmallDilationFirstTwoModel, self).__init__()
        ...
        # Layer 2: Standard kernel size, dilation rate 4
        kernel_size2 = 3
        dilation2 = 4
        ...
        # Layer 3: Standard convolution (no dilation)
        kernel_size3 = 3
        padding3 = 1  # Standard padding for 3x3 kernel
    ...
    def forward(self, x):
        ...
        # 2. Dilated Convolutional Layers (first two)
