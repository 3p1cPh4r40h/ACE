...
class MultiDilation248ChordCNN(nn.Module):
    """
    A CNN model for chord extraction using a multi-dilation block
    with dilation rates [2, 4, 8] to capture features at multiple scales simultaneously.
    """
    def __init__(self, num_classes, input_height=9, input_width=24,
        ...
        super(MultiDilation248ChordCNN, self).__init__()
